---
description: Record a coding tradeoff at decision time (superdev KB repos) — constants, thresholds, approach choices, library picks.
...
canonical procedure also lives at `.agents/skills/superdev-decide/SKILL.md`.)
