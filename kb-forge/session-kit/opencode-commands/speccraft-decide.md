---
description: Record a tradeoff at the moment it is made — fixed constant or threshold, choice between approaches, tolerated failure mode, rejected alternative, library pick — so it is never lost to archaeology.
---
