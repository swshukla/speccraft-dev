---
description: Pull trust-graded KB facts governing the code you are about to touch. Run at task start, before writing code, and before adding any integration or data fetch.
---
...
5. If the output says **NO KB COVERAGE** and any target path matches the
   ...
   this deny; OpenCode sessions don't get that hook, so self-apply it here
